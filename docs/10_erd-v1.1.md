...
erDiagram
  ...
  USERS ||--o{ EVENT_PARTICIPANTS : is
  EVENTS ||--o{ EVENT_PARTICIPANTS : has
  EVENTS ||--o{ BOTTLE_ENTRIES : includes
  EVENT_PARTICIPANTS ||--o{ BOTTLE_ENTRIES : brings
  USERS ||--o{ BOTTLE_ENTRIES : owns
  PRODUCERS ||--o{ WINES : makes
  WINES ||--o{ BOTTLE_ENTRIES : matches
  BOTTLE_ENTRIES ||--o{ BOTTLE_PHOTOS : has
  SUBSCRIPTION_PLANS ||--o{ USERS : applies
